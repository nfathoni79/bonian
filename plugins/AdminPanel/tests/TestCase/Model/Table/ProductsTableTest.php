...
class ProductsTableTest extends TestCase
{
    ...
    public $fixtures = [
        ...
        'plugin.AdminPanel.ProductStockStatuses',
        'plugin.AdminPanel.ProductWeightClasses',
        'plugin.AdminPanel.ProductStatuses',
        'plugin.AdminPanel.OrderProducts',
        'plugin.AdminPanel.ProductAttributes',
        'plugin.AdminPanel.ProductDeals',
        'plugin.AdminPanel.ProductDiscounts',
