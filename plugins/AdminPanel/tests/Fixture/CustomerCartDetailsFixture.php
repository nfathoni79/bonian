...
class CustomerCartDetailsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'point' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => ''],
        ...
        'totalpoint' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => ''],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'created' => '2019-03-13 18:08:23',
                'modified' => '2019-03-13 18:08:23'
            ],
        ];
        parent::init();
    }
