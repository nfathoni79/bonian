...
class VillagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'villages_district_id_index' => ['type' => 'index', 'columns' => ['district_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'villages_ibfk_1' => ['type' => 'foreign', 'columns' => ['district_id'], 'references' => ['districts', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
