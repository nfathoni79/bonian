...
class ProductStockMutationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'product_stock_mutation_type_id' => ['type' => 'integer', 'length' => 3, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'product_stock_mutations_ibfk_5' => ['type' => 'foreign', 'columns' => ['product_id'], 'references' => ['product_option_stocks', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
