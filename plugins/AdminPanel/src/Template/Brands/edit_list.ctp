...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="<?= $this->Url->build(['action' => 'lists']); ?>" class="m-nav__link">
                            <span class="m-nav__link-text">
                                <?= __('Daftar Brands') ?>
                            </span>
                        </a>
    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            ...
            <?= $this->Form->create($brands, ['class' => 'm-login__form m-form', 'templates' => 'AdminPanel.app_form','type' => 'file']); ?>
            ...
            <?php
                ...
                echo $this->Form->control('logo',['class' => $default_class, 'type' => 'file', 'label' => 'Logo (160x72px)']);
            ?>
            </div>
