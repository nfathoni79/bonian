    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__body">
                ...
                <div class="m_datatable" id="table-balances"></div>
...
$requestUrl = $this->Url->build(['action' => 'balance']).'/'.$this->request->params['pass'][0];
}else{
...
<script>
    ...
    var DatatableRemoteAjaxDemo = function() {
        var demo = function() {
            var datatable = $('#table-balances').mDatatable({
                data: {
                    type: 'remote',
                    source: {
                        read: {
                ...
                columns: [
                    ...
                    {
                        field: 'CustomerMutationAmountTypes.name',
                        title: 'Type',
                        template: function(row) {
                            return row.customer_mutation_amount_type.name + ' ['+row.customer_mutation_amount_type.type+']';
                        }
                    },
                    {
                        field: 'description',
