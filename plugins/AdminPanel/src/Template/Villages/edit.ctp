...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            ...
            <?= $this->Form->create($village,['class' => 'm-login__form m-form', 'templates' => 'AdminPanel.app_form']); ?>
            <div class="m-portlet__body">

            <?php
                echo $this->Flash->render();
                $default_class = 'form-control form-control-danger m-input m-input--air';
                echo $this->Form->control('district_id', ['options' => $districts, 'class' => $default_class]);
