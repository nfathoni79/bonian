...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            ...
            <?= $this->Form->create($gameWheel,['class' => 'm-login__form m-form', 'templates' => 'AdminPanel.app_form']); ?>
            <div class="m-portlet__body">

            <?php
                echo $this->Flash->render();
                $default_class = 'form-control form-control-danger m-input m-input--air';
                echo $this->Form->control('product_name',['class' => $default_class]);
                echo $this->Form->control('probability',['class' => $default_class]);
            ?>
            </div>
