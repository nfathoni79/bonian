 ...
 * @var \Cake\Datasource\EntityInterface[]|\Cake\Collection\CollectionInterface $productPromotions
 * nevix
 */
?>
    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
                        ...
                        <li class="m-portlet__nav-item">
                            <a href="<?= $this->Url->build(['action' => 'add']); ?>" class="btn btn-primary m-btn m-btn--pill m-btn--custom m-btn--icon m-btn--air">
                                <span>
                                    ...
                                    <span><?= __('New Product Promotion') ?></span>
                                </span>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="m-portlet__body">
                ...
                <div class="m_datatable" id="table-productPromotions"></div>
...
<script>
    ...
    var DatatableRemoteAjaxDemo = function() {
        var demo = function() {
            var datatable = $('#table-productPromotions').mDatatable({
                data: {
                    type: 'remote',
                    source: {
                        read: {
                ...
                columns: [
                    ...
                    {
                        field: 'ProductPromotions.product_id',
                        title: 'Product_id',
                        template: function(row) {
                    ...
                    {
                        field: 'ProductPromotions.min_qty',
                        title: 'Min_qty',
                        template: function(row) {
                            return row.min_qty;
                        }
                    ...
                    {
                        field: 'ProductPromotions.free_qty',
                        title: 'Free_qty',
                        template: function(row) {
                            return row.free_qty;
                        }
                    ...
                    {
                        field: 'ProductPromotions.date_start',
                        title: 'Date_start',
                        template: function(row) {
                    ...
                    {
                        field: 'ProductPromotions.date_end',
                        title: 'Date_end',
                        template: function(row) {
                            return row.date_end;
                        }
                    ...
                    {
                        field: 'ProductPromotions.created',
                        title: 'Created',
                        template: function(row) {
                            return row.created;
                        }
