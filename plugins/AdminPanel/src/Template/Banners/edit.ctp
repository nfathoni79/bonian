...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            ...
            <?= $this->Form->create($banner,['class' => 'm-login__form m-form', 'templates' => 'AdminPanel.app_form']); ?>
            ...
            <?php
                ...
                echo $this->Form->control('dir',['class' => $default_class]);
                echo $this->Form->control('size',['class' => $default_class]);
