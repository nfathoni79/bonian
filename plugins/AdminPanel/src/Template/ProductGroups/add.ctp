            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group m--margin-top-10">
                    <div class="alert m-alert m-alert--default" role="alert">
                        Produk yang akan dijual dalam group sale <a href="javascript:void(0);" class="btn btn-success m-btn m-btn--custom m-btn--icon add-group-sale"><span>Tambah Produk Group Sale</span></a>
                    </div>
                </div>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-4">
                                <div class="m-typeahead">
                                    <input type="text" name="ProductGroupDetails[0][produk]" placeholder="Pencarian Produk" class="form-control form-control-danger m-input m-input--air k_typeahead" dir="ltr" data-row="0">
        ...
        $('.k_typeahead'+rows).on('typeahead:select', function(evt, item) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    '<input type="hidden" name="ProductGroupDetails['+row+'][produk_id]" class="form-control form-control-danger m-input m-input--air" value="'+data.id+'">\n'+
                    '<input type="text" name="ProductGroupDetails['+row+'][price_sale]" class="form-control form-control-danger m-input m-input--air" placeholder="Harga Flash Sale">\n' +
                    '</div>\n' +
                    '</div>\n' +
                    '</div>\n' +
                    '</div>';
