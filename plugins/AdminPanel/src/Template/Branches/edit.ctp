    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            ...
            <?php
                ...
                echo $this->Form->control('provice_id', ['options' => $provinces, 'class' => $default_class]);
                echo $this->Form->control('city_id', ['options' => $cities, 'class' => $default_class]);
                echo $this->Form->control('subdistrict_id', ['options' => $subdistricts, 'class' => $default_class]);
                echo $this->Form->control('latitude',['class' => $default_class]);
                echo $this->Form->control('longitude',['class' => $default_class]);
            ?>
            </div>
