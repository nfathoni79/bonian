    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            ...
            <?php
                ...
                echo $this->Form->control('city_id', ['options' => $cities,'class' => 'form-control m-select2','id' => 'optcity','empty' => 'Pilihan','label' => 'Kota']);
                echo $this->Form->control('subdistrict_id', ['options' => $subdistricts,'class' => 'form-control m-select2','id' => 'optsubdistrict','empty' => 'Pilihan','label' => 'Kabupaten']);
