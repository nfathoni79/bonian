 ...
 * @property \AdminPanel\Model\Table\CustomerNotificationsTable $CustomerNotifications
 * @property \AdminPanel\Controller\Component\PusherComponent $Pusher
 * @property \AdminPanel\Model\Entity\CustomerNotification $notificationEntity
 */
class NotificationComponent extends Component
{
    ...
    {
        $this->CustomerNotifications = (new TableLocator ())->get('AdminPanel.CustomerNotifications');
    }

    /**
     * @return \AdminPanel\Model\Table\CustomerNotificationsTable
     */
    ...
    {
        if ($this->notificationEntity instanceof \AdminPanel\Model\Entity\CustomerNotification) {
     ...
     * @param null $action
     * @param null $template
     * @return \AdminPanel\Model\Entity\CustomerNotification|bool
     */
