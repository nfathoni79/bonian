<div style="padding: 5px 20px; border-top: 1px solid rgba(0,0,0,0.05);">
    ...
    <div style="color: #636363; font-size: 14px;">
        ...
        <p><a href="<?= $this->Url->build(['plugin' => 'MemberPanel', 'controller' => 'Account', 'action' => 'reset',$code], true); ?>" style="padding:8px 20px;background-color:#4b72fa;color:#fff;font-weight:bolder;font-size:16px;display:inline-block;margin:20px 0px;text-decoration:none"><?= __d('MemberPanel', 'RESET PASSWORD'); ?></a> </p>
