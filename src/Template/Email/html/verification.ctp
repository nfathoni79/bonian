<div style="padding: 5px 20px; border-top: 1px solid rgba(0,0,0,0.05);">
    ...
    <div style="color: #636363; font-size: 14px;">
        <p>Kamu telah mendaftarkan email <?php echo $email;?> sebagai alamat email kamu di bonian. </p>
        <p>Ayo verifikasi email kamu di bonian, dan dapatkan berbagai penawaran ekslusif dan tips-tips menarik dari bonian.</p>
